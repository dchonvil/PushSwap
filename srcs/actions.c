...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/17 09:06:10 by dchonvil          #+#    #+#             */
/*   Updated: 2021/12/18 03:36:39 by dchonvil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	treat_rmove(t_mlist *mapl, int size, char name)
{
	long long int	*tmp;
...
void	treat_rrmove(t_mlist *mapl, int size, char name)
{
	int				c;
	long long int	*tmp;
