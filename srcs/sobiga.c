...
/*   Updated: 2021/12/18 03:47:58 by dchonvil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	restore_a(t_mlist *mapl, long long int chk)
{
	int	c;
	int	i;
	int	j;
...
void	check_depil(t_mlist *mapl, long long int chk, int m, int j)
{
	int				c;
	int				i;
	long long int	n;
...
void	treat_sobiga(t_mlist *mapl)
{
	int	c;
	int	i;
	int	j;
