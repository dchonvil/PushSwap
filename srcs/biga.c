...
/*   Updated: 2021/12/18 03:38:33 by dchonvil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	treat_lsta(t_mlist *mapl, int p)
{
	int				c;
	long long int	chk;
...
void	back_lsta(t_mlist *mapl, int *j, int m, int n)
{
	int	c;
	int	i;
	int	p;
...
int	front_lsta(t_mlist *mapl, int *j, int m, int n)
{
	int	c;
	int	i;
	int	s;
...
void	treat_biga(t_mlist *mapl, int *c)
{
	int				i;
	int				j;
	long long int	chk;
